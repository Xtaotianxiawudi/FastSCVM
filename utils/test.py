...
def main():
    ...
    parser.add_argument('--model-file', type=str, default='./logs/refuge/20231009_095313.828073/checkpoint_44.pth.tar',
                        help='Model path')
    parser.add_argument(
    ...
    _, _, mae_cdr, _ = evaluate_segmentation_results(
        ...
        osp.join(args.test_prediction_save_path, args.dataset, 'pred_mask', 'refuge', 'test', 'image'),
